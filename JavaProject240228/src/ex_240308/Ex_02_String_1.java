...
public class Ex_02_String_1 {
	...
	public static void main(String[] args) {
		// String, 참조형, 클래스다.
		// 메모리 소모가 심하다. 변경이 불가능. 그래서 새로 생성한다.
		// 관련 메서드들 확인.
...
//		System.out.println("str2.hashCode: " + System.identityHashCode(str2));
		...
		// equals, 문자열 비교하기.
		// 주의사항, 정수 비교 하듯이 "==" 등의 연산자를 사용하면 안됨.
		...
		// boolean contains(charSeqeunce s) : s에 지정된 문자들을 포함하고 있으면 리턴.
		...
		// 응용 검색 기능. 임시 더미 DB
		// apple 검색해보기.
		System.out.println("apple 검색해보기.: " + searchFruit("aplle"));
		...
		String[] resultArray1 = str12.split("");
        ...
        // 응용 1) 검색시, 복붙을 하는데, 공백이 섞여있음.
		// 대소문자 상관없이 등 검색할 때,
		// 입력된 문자열이,  
		// 응용 2) 입력된 파일의 확장자를 기준으로, 이미지 파일의 종류를 분히
		// abc.jpg, def.png, ghi.jpeg, abcd.MDV, ega.mp4
		// 예) 게시글 작성시 첨부 파일로, 사진도 업로드, 영상도 업로드,
		// 내가 올린 게시글을 출력시, 이미지 로딩, 영상 로딩을 할지 분리.
	...
	// 메서드에 입력값에 키워드를 디비로 전달하고, (백엔드)
	// DB : select 구문에서 LIKE 절에서, 해당 내용이 있는지 검색. true, false (DB서버)
	// 해당 내용을, 다시 화면으로 전달.
