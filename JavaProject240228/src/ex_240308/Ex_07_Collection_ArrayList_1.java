...
public class Ex_07_Collection_ArrayList_1 {
	...
	public static void main(String[] args) {
		...
		for (String str : arrayList) {
			System.out.println("arrayList의 요소값 출력: " + str);
		}
		...
		// 출력
		for (String str : arrayList) {
			System.out.println("arrayList의 1번 요소값 삭제후 출력: " + str);
		}
		...
		// ArrayList에 있는 모든 요소가 it1, 인스턴스에 다 들어가 있다.
		// 비유 하자면, 특정 테이블에 1번,2번,순서대로 기록이 되어있다.
		...
		while(it1.hasNext()) {
			...
			// 순서3, 값을 가져오기
			String str = it1.next();
			System.out.println("Iterator를 이용한 출력: " + str);
		}
