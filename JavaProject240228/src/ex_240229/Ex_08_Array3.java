...
public class Ex_08_Array3 {
	...
	public static void main(String[] args) {
		// 양수 5개를 입력받아서, 배열에 저장하고, 제일 큰수를 출력하기. 합계, 평균, 최소값구하기.
		// 함수를 만들어서, 매개변수에 배열 타입으로 받아서, 출력하기.
		Scanner scanner = new Scanner(System.in);

		System.out.println("(1~100)중에서 연속된 양수만 5개 입력해주세요>>");
		// 배열선언
		...
		// 최소값, 배열을 정렬 후, (오름차순으로 정렬하고, 첫번째 요소가 가장 작은 요소가됨.)
		...
		// 0 이상 100 미만의 양수 중에서, 랜덤으로 5개 선택해서, 배열에 담아서,
