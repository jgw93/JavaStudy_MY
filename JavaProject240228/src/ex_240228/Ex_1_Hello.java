...
public class Ex_1_Hello {
	...
	public static void main(String[] args) {
		...
		String str = "장규원"; // 문자열 표기시 사용, String 기본형이 아니다, 참조형. 큰 따옴표 사용.

		int resultNum = sum(100, 200); // sum
		// 출력해보기.
		// 주석 : 멀티 주석, ctrl + shift + /
		// 주석 : 멀티 주석 해제, ctrl + shift + \
		// 단축키, 1) 자동완성, 2) 자동정렬( ctrl + shift + F)
		// 자바, 들여쓰기가 의무는 아님. 하지만, 코드의 가독성을 위해서, 가급적 들여쓰기 하기.

		System.out.println("출력 연습: 단축키 : syso, ctrl + space입력");
