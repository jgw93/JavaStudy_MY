...
//	SizeBarLabel sizeBarLabel = new SizeBarLabel();
	...
	// 응용 순서2, 수치 라벨의 인스턴스를, MyLabel에서 스레드로, 바크기에 맞게 그려지고있음.
	// SizeLabel 인스턴스를, MyLabel에 던졌음.
	// 왜? 스레드가 동작 중인데, MyLabel 동작중, 매번 barSize의 크기가 지정이 되니,
	// MyLabel의 크기를 -> SizeBarLabel, 크기 값을 전달을 했음. 
        // call by value는 메소드 안에서 값이 사용후 휘발, 사라지지만,
	// 여기서 인스턴스를 사용해서, 계속 그 인스턴스를 유지함.
