...
class TimerThread2 extends Thread {
	// JLavel, 자바 버전의 화면 UI -> 빈 도화지 역할.
	public JLabel timerLabel;

	// 매개변수가 1개인 생성자를 호출하는데. timerLabel, 화면을 인스턴스로 받기
	public TimerThread2(JLabel timerLabel) { // timerLabel 로 받기
...
class TimerThread3 implements Runnable {
	...
	// 매개변수가 1개인 생성자를 호출하는데. timerLabel, 화면을 인스턴스로 받기
	public TimerThread3(JLabel timerLabel) { // timerLabel 로 받기
		this.timerLabel = timerLabel;
	}
...
public class Ex_02_Thread_class_with_UI_2 extends JFrame {
	// 화면을 그리기 위해서, 기본생성자에서, 화면을 그리기 위한 준비단계
	Ex_02_Thread_class_with_UI_2() {
		// 윈도우 부모 창에 제목
		...
		// 옵션, 글꼴 모양, 기울기, 크기등.
		// FlowLayout 의 많은 메서드 중에서, setFont 메서드를 이용하고,
		// setFont (Font 참조형변수)
		...
		// JLabel 배경색 기본 투명인데, 해당 함수 이용해서, 배경색 지정하기.
	...
	public static void main(String[] args) {
		...
		// JFrame 클래스 상속받기.
		Ex_02_Thread_class_with_UI_2 test = new Ex_02_Thread_class_with_UI_2();
