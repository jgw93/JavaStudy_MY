...
public class Ex_01_try_catch_1 {
	...
	public static void main(String[] args) {
		...
		// 예) 파일을 입출력, 네크워크 통신을 통해서, 데이터를 못받아올때
		// (파일 입출력, 네트워크 통신[소켓], 할 때 반드시 컴파일러에서 의무적으로 예외처리를 요구함.)
		
		// 예외 처리하는 형식도 각각의 디테일하게 조정을 할수 있지만
		// 그 디테일한 예외처리를 포함한, 범위가 넒은 예외를 처리하는 경우도 있음.
		
        // 예외처리가 1) 배열의 범위를 벗어나는 인덱스에 접근
		// 2) 0으로 나누는 경우
		// 3) 콘솔에서, 정수인데 문자열을 입력하는 경우
		// 여기 전부다 발생하지 않는 상황임. (실무에서는)
		// try catch finally 기본 구문 연습용으로 -> 2번, 타자 연습해보기.
		...
		// try catch finally 없이, 비정상적인 종료 발생시켰고
		...
		//} catch (ArithmeticException e) {
			...
			// 스캐너 인스턴스 닫을때 사용함.
			System.out.println("예외 처리후, finally 실행함.");
			scanner.close();
